...
public class ChatActivity extends AppCompatActivity {
    ...
    private com.example.android.chatapp.User user;
    private Chat chat;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user = (com.example.android.chatapp.User) getIntent().getSerializableExtra("user");
                ...
                .addSnapshotListener(new EventListener<QuerySnapshot>() {
                    ...
                    public void onEvent(@Nullable QuerySnapshot snapshots, @Nullable FirebaseFirestoreException e) {
                        for (DocumentChange change : snapshots.getDocumentChanges()){
                            Message name = change.getDocument().toObject(Message.class);
                            user.setDisplayName(change.getDocument().getId());
                            list.add(name);
                            adapter.notifyDataSetChanged();
                        }
                    }
